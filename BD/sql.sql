...
--
-- Servidor: localhost
-- Tiempo de generación: 04-01-2017 a las 19:58:34
-- Versión del servidor: 5.5.44-0+deb8u1
-- Versión de PHP: 5.6.13-0+deb8u1


DROP DATABASE IF EXISTS ET3Grupo5;
CREATE DATABASE ET3Grupo5 DEFAULT CHARACTER SET UTF8 COLLATE utf8_general_ci;
USE ET3Grupo5;
