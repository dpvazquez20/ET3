PROCESO DE INSTALACION:
	...
	- Ejecutar el install.sh (Si la ejecucion de este archivo produce un error, se debe a que Windows y GitHub
		...
		tipo Windows al subir el archivo al repositorio. Para solucionarlo, es preciso escribirlo en un SO Linux
		para sustituir dichos saltos de linea.)
	- Ejecutar el install.php con nombre de usuario y contrasena los de tu maquina virtual
	- Ejecutar la aplicacion:
		- Nombre: ET3Grupo5	Contrasena: ET3Grupo5   (este usuario es un admin)
		- Nombre: user		Contrasena: user	(este usuario es un usuario normal)