            ...
            <div>
                ...
                <div class="col-sm-4">
                    ...
                    <form role="form" method="get">
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="input-group">
                                    <select id="controladorBuscar" name="controladorBuscar"style="width: 200px" class=" form-control">
                                        <?php
                ...
                <table class=" table table-striped table-responsive">
                    ...
                    if(isset($_GET['perfilBuscar'])) {
                        $resul= Permiso_modelo::getPermisosPerfil($_GET['perfilBuscar']);
                    }else{
                        if(isset($_GET['controladorBuscar'])){
                           $resul = Permiso_modelo::getPermisosControlador($_GET['controladorBuscar']);
                        }else {
                        ...
                        while($accion = mysqli_fetch_assoc($listaControladores)){
                            if($accion['controlador']==$_GET['ctr']) {
                                if ($accion['accion'] != "ADD") {
                                    ...
                                    echo "<a href='../controladores/" . $accion['controlador'] . "_Controller.php?id=" . $accion['accion'] . $accion['controlador'] . "&idPermiso=" . $row['id_permiso'] . "'><button class='" . $estilo . "'>" .$nombreBoton. "</button></a>";
                                }
                            }
                        }
                        echo"</td></tr>";
