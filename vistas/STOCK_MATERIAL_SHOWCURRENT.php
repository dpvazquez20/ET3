    ...
    function render(){
        ...
        <title><?php echo $literales['detalleStock']; ?></title>
                ...
                <form>
                    ...
                    <div class="form-group">
                            <a class="btn btn-default"href="STOCK_MATERIAL_Controller.php?id=SHOWALLSTOCK_MATERIAL&ctr=STOCK_MATERIAL"><?php echo $literales['volverStock'];?></a>
                    </div>
